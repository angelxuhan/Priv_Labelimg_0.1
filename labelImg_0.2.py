...
###################这部分代码开始加入整个布局了#####################
        ...
        next_rects=action('&Next Image', self.openNextrects,
                             '1')
    ...
    def saveLabels(self, filename):
        ...
        if self.task_mode in [0,1]:# seg and det mode
            ...
            print("point_mode:" + str(self.task_mode))
            self.defaultsavedpath()
            print('point self.savePath:', self.filepath)
            ...
            with codecs.open(savefilename_txt, 'w') as outfile:
                for i in range(len(self.canvas.point_point_list)) :
                    # self.point_visible.append(self.canvas.point_visible[i])
                    print(self.canvas.point_point_list[i])
                ...
                with open(filepath) as infile:
                    ...
                    for i,line in enumerate(lines):
                        if '[' not in line:
                            ...
                            print(self.labelHist.index(label))
                    ...
                    self.canvas.point_load(point_list)
            else:
    ...
    def loadFile(self, filename=None):
        ...
        if QFile.exists(filename):
            ...
            if self.task_mode in [0,1]:
                ...
                print(txtPath)
                # self.canvas.point_load(txtPath)
                self.loadCLSFile(txtPath)
